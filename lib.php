 ...
 * @return string
 */
function theme_demo_get_main_scss_content($theme) {
    global $CFG;
   ...
   // Theme specific SCSS
    $pre = file_get_contents($CFG->dirroot . '/theme/demo/scss/pre.scss');
    $post = file_get_contents($CFG->dirroot . '/theme/demo/scss/post.scss');
